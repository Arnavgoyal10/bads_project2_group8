...
- **Critical Gap**: There are 6 'Champions' who have NOT opted into email. This represents a significant risk to CRM retention efforts.


## Segment Migration Potential

- **Engaged Browsers → Core Buyers**: 15% of 'Engaged Browsers' have checkout_started=True but no orders. A single 10% discount nudge could migrate them to 'Core Buyers'.

- **Core Buyers → Champions**: 12% of 'Core Buyers' match the frequency of 'Champions' but have lower AOV. Upsell bundles are the recommended migration path.
