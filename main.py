...
def main():
    ...
    phases = {
        ...
        2: "scripts/02_descriptive_stats.py",
        3: "scripts/03_segmentation.py",
        4: "scripts/04_campaign_grouping.py",
        5: "scripts/05_lead_prediction.py",
        6: "scripts/06_retention_prediction.py",
        7: "scripts/08_additional_analysis.py",
        8: "scripts/07_executive_dashboard.py"
    }
